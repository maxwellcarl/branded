...
<div class="parallax-window services-parallax" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/plants.jpg">
...
<section class="content-block" style="padding: 60px 0 100px; position: relative; display:block; background: white; text-align: center;">
	<div class="container">
		<div class="services-callouts cf">
			<div class="col-md-4">
				<h1 class="gradient-roll">Web Services</h1>
			...
			<div class="col-md-4">
				<h1 class="gradient-roll-reverse">Branding / Identity</h1>
			...
			<div class="col-md-4">
				<h1 class="gradient-roll">Production</h1>
